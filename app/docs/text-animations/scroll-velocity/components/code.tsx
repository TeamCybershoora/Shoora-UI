...
export default function View() {
  ...
  return (
    <div className="relative p-8 h-[25rem]">
        <button
          onClick={handleRepeat}
          className="absolute top-2 right-4 p-2 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-colors"
        ...
        <div 
          ...
          style={{ padding: '0 60px', marginLeft: "10rem" }}
        >
          <h1 className="text-7xl font-bold text-white">
            {renderText("Hello Shoora UI")}
          </h1>
        </div>
      </div>
  );
