...
export default function Usage() {
  const codeLines = [
    ...
    '    <div',
    '      ref={containerRef}',
    '      style={{ position: "relative", padding: "3rem", background: "#020617" }}',
    '    >',
    '      <VariableProximity',
    '        label="Hover me! And then star Shoora UI on GitHub, or else..."',
    '        className="variable-proximity-demo text-5xl md:text-6xl font-black tracking-tight text-white"',
