  ...
  const props = [
    {
      ...
      type: 'number',
      default: '0',
      description: 'The initial opacity of the text before the scroll animation.',
    },
    {
      name: 'enableBlur',
      type: 'boolean',
      default: 'true',
      description: 'Whether to enable blur effect during the scroll animation.',
    },
    {
      name: 'baseRotation',
      type: 'number',
      default: '5',
      description: 'The initial rotation angle of the text in degrees.',
    },
    {
      name: 'blurStrength',
      type: 'number',
      default: '10',
      description: 'The strength of the blur effect in pixels.',
    },
    {
      name: 'children',
