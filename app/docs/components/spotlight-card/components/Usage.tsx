...
export default function Usage() {
  const codeLines = [
    ...
    '      description="An interactive spotlight effect card with smooth animations"',
    ...
    '      borderColor="#60496e"',
    '      enableGlow={true}',
    '      glowColor="rgba(96, 73, 110, 0.5)"',
    '      enableAnimation={true}',
    '      animationSpeed={2}',
    '      className="custom-spotlight-card"',
    '      onSpotlightMove={(position) => console.log("Spotlight moved to:", position)}',
    '    >',
    '      {/* Content goes here */',
    '      <div className="p-6">',
    '        <h3 className="text-xl font-bold text-white mb-2">Interactive Spotlight</h3>',
    '        <p className="text-gray-300">Move your mouse over the card to see the spotlight effect!</p>',
    '      </div>',
    '    </SpotlightCard>',
    '  );',
    '}',
